...
public:
     ...
     * @return An expected object containing the number of bytes read on success, or an error message on failure.
     */
     ...
     * @return The twos-compliment sample value at the specified frame and channel.
     */
